...
👆 理論値。適当に実験して５００回に１回ぐらい、くじが１本出てこないことがある程度の精度  
...
👆 遊びで使うのに実用的な値。マジックナンバー a=およそ 18。１００００回に１回ぐらいくじがでてこないことがある程度（＾～＾）  

日本語難しいんで Pythonコードで示す。 理屈は数学の作法分からんので お絵描きして、このページの下の方で示した。  
...
![20220127go38a2.png](./doc/20220127go38a2.png)  

👆 これ、ガウス分布（＾～＾）  

確率密度:  

![20220127go38a3b2c2.png](./doc/20220127go38a3b2c2.png)  

👆 これ、確率密度を 1 とする、と言ってるイラスト（＾～＾）  

![20220127go44.png](./doc/20220127go44.png)  

👆 着想としては *鳩の巣原理* の乱数版を作りたかったんで *パスカルの三角形* を照らし合わせたわけだぜ（＾～＾）  

![20220129go55.png](./doc/20220129go55.png)  

👆 *鳩の巣* したかったんだぜ（＾～＾）  

![20220129go62.png](./doc/20220129go62.png)  

👆 じゃあ箱の数を `2π` にしたらどうだ、っていうと、それ、ただの *鳩の巣原理* （＾～＾）  
パスカルの三角形の意味が消えてるぜ（＾～＾）  
鳩の方に、パスカルの三角形 の意味付けが要るな（＾～＾）  

![20220129go63.png](./doc/20220129go63.png)  

👆 無限大にでかい パスカルの三角形の底辺の長さって なんか `e` な感じあるよな、と　わたしが勝手に思っていて（＾～＾）  

![20220129go64.png](./doc/20220129go64.png)  
